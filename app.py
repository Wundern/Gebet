...
auth0 = oauth.register(
    ...
    #server_metadata_url='https://wunder-willen.jp.auth0.com'
)
...
def login():
    ...
    return auth0.authorize_redirect(redirect_uri='https://5dc8-240f-34-2d24-1-e814-ef88-50d1-5868.jp.ngrok.io/callback')
